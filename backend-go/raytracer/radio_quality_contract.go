...
const (
	...
	RadioQualityOptimizationCoupling          = "optional soft objective; no radio-quality hard constraint or scheduler optimization"
	...
	RadioQualityOptimizationDomainSource      = "interference_compatibility_grid_union"
	RadioQualityOptimizationDomainIDVersion   = "atom-radio-quality-optimization-grid-v1"
	RadioQualityOptimizationDomainDescription = "Deterministic union grid of per-cell effective-radius disks; fixed before azimuth scoring and sampled, not a continuous-area integral"
	RadioQualityOptimizationSampleOrdering    = "row-major grid row then column"
	RadioQualityOptimizationHorizonMode       = "per_cell_effective_radius"
	RadioQualityOptimizationUnavailableReason = "unsupported_radio_quality_model"
)
