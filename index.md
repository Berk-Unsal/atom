...
- [Concept 7D local report and artifact delivery](concept-7d-report-artifacts.md): explicit ReportDefinitions, immutable report artifacts, historical Run generation, SHA-256 verification, offline download, regeneration, corruption handling, and local retention boundaries.
- [Concept 7E Scenario, Version, and Branch UX](concept-7e-scenario-ux.md): explicit immutable Versions, draft/Save version semantics, Scenario switching, input diffs, branch and duplicate lineage, optimization application, Run/Report navigation, and safe input-first comparison.
- [Concept 7H RF configuration progressive disclosure](concept-7h-rf-progressive-disclosure.html): Planning, Advanced, and Research/reference tiers; 190-control inventory; model boundaries; drawer-density and responsive evidence; compatibility checks.
